...
export const lgLayout: Layout[] = [
    ...
    { i: 'lbVtSe', x: 0, y: 1, w: 2, h: 1 },
    { i: 'laifen618', x: 0, y: 1, w: 2, h: 1 },
    { i: 'LaifenChristmas', x: 0, y: 2, w: 2, h: 1 },
    { i: 'laifen1111', x: 2, y: 2, w: 1, h: 2 },
    { i: 'laifenSe', x: 3, y: 3, w: 1, h: 2 },
    ...
    // { i: 'cv', x: 10, y: 10, w: 1, h: 1 },

    // { i: 'github', x: 10, y: 10, w: 1, h: 1 },
    // { i: 'linkedin', x: 10, y: 10, w: 1, h: 1 },
    // { i: 'location', x: 2, y: 0, w: 1, h: 1 },
    // { i: 'project-1', x: 10, y: 10, w: 1, h: 2 },

    // { i: 'project-2', x: 10, y: 10, w: 2, h: 1 },
    // { i: 'Spotifyttt', x: 10, y: 10, w: 1, h: 1 },
